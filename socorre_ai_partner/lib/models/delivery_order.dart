...
class DeliveryOrder {
  ...
  DeliveryOrder copyWith({
    ...
    return DeliveryOrder(
      ...
      motoboyFee: motoboyFee ?? this.motoboyFee,
      ...
      motoboyNotes: motoboyNotes ?? this.motoboyNotes,
  ...
  // Getters úteis
  bool get isActive => status == DeliveryOrderStatus.pending || status == DeliveryOrderStatus.accepted || status == DeliveryOrderStatus.pickedUp || status == DeliveryOrderStatus.inTransit;
  bool get isCompleted => status == DeliveryOrderStatus.delivered;
  bool get isCancelled => status == DeliveryOrderStatus.cancelled || status == DeliveryOrderStatus.failed;
