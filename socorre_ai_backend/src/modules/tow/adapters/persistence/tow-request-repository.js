...
const COLUMNS = Object.freeze([
  ...
  // SERVICE LOCATION — additive place identity (migration 012). NULL for a
  // generic coordinate and for every row created before the adoption.
  'pickup_place_id',
...
function toColumns(record) {
  return {
    ...
    pickup_place_id: record.pickup.place_id ?? null,
    ...
    destination_place_id: record.destination.place_id ?? null,
...
function mapRow(row) {
  ...
  return {
    ...
    pickup: {
      ...
      place_id: row.pickup_place_id ?? null,
    },
    destination: {
      ...
      place_id: row.destination_place_id ?? null,
    },
    vehicle: {
